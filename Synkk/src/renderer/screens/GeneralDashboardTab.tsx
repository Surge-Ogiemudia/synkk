    ...
    <div className="w-full h-full flex flex-col bg-[#050505] relative animate-in fade-in duration-500">
      {loadError && (
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-[#090D16] p-6 text-center">
          ...
          <h3 className="text-xl font-bold text-white mb-2">PSX Web Module Unreachable</h3>
          <p className="text-slate-400 text-sm max-w-md mb-6">
            Unable to connect to <span className="text-emerald-400 font-mono">psx.ng</span>. Please check your network connection or verify that the web app has been loaded at least once online to cache assets.
          </p>
          <button
            onClick={handleRetry}
